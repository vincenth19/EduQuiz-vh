...
# Create robust notebook with test and full runners
notebook = {
    "cells": [
        {
            "cell_type": "code",
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# A1 TEST: Single-agent, standard model (5 items)\n",
                "def run_a1_test():\n",
                "    print(\"Running A1 TEST: 5 items\")\n",
                "    \n",
                "    requests = []\n",
                "    for i in range(5):\n",
                ...
                "        })\n",
                "    \n",
                "    batch_file = f\"{output_dir}/batch_a1_test.jsonl\"\n",
                ...
                "            metadata={\"scenario\": \"A1_test\", \"model\": \"gpt-4\"}\n",
                "        )\n",
                "        \n",
                "        print(f\"A1 TEST batch created: {batch.id}\")\n",
                "        return batch.id\n",
                "        \n",
                "    except Exception as e:\n",
                "        print(f\"Error: {e}\")\n",
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# A1 FULL: Single-agent, standard model (950 items)\n",
                "def run_a1_full():\n",
                "    print(\"Running A1 FULL: 950 items\")\n",
                "    \n",
                "    requests = []\n",
                ...
                "        })\n",
                "    \n",
                "    batch_file = f\"{output_dir}/batch_a1_full.jsonl\"\n",
                "    with open(batch_file, 'w') as f:\n",
                "        for request in requests:\n",
                "            f.write(json.dumps(request) + '\\n')\n",
                "    \n",
                ...
                "            endpoint=\"/v1/chat/completions\",\n",
                "            completion_window=\"24h\",\n",
                "            metadata={\"scenario\": \"A1_full\", \"model\": \"gpt-4\"}\n",
                "        )\n",
                "        \n",
                "        print(f\"A1 FULL batch created: {batch.id}\")\n",
                "        return batch.id\n",
                "        \n",
                "    except Exception as e:\n",
                "        print(f\"Error: {e}\")\n",
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# A2 TEST: Single-agent, reasoning model (3 items)\n",
                "def run_a2_test():\n",
                "    print(\"Running A2 TEST: 3 items\")\n",
                "    \n",
                "    requests = []\n",
                "    for i in range(3):\n",
                "        passage = extract_passage(test_data[i]['prompt'])\n",
                ...
                "        })\n",
                "    \n",
                "    batch_file = f\"{output_dir}/batch_a2_test.jsonl\"\n",
                "    with open(batch_file, 'w') as f:\n",
                "        for request in requests:\n",
                "            f.write(json.dumps(request) + '\\n')\n",
                "    \n",
                ...
                "            endpoint=\"/v1/chat/completions\",\n",
                "            completion_window=\"24h\",\n",
                "            metadata={\"scenario\": \"A2_test\", \"model\": \"gpt-5-2025-08-07\"}\n",
                "        )\n",
                "        \n",
                "        print(f\"A2 TEST batch created: {batch.id}\")\n",
                "        return batch.id\n",
                "        \n",
                "    except Exception as e:\n",
                "        print(f\"Error: {e}\")\n",
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# A2 FULL: Single-agent, reasoning model (150 items)\n",
                "def run_a2_full():\n",
                "    print(\"Running A2 FULL: 150 items\")\n",
                "    \n",
                "    requests = []\n",
                ...
                "        })\n",
                "    \n",
                "    batch_file = f\"{output_dir}/batch_a2_full.jsonl\"\n",
                "    with open(batch_file, 'w') as f:\n",
                "        for request in requests:\n",
                "            f.write(json.dumps(request) + '\\n')\n",
                "    \n",
                ...
                "            endpoint=\"/v1/chat/completions\",\n",
                "            completion_window=\"24h\",\n",
                "            metadata={\"scenario\": \"A2_full\", \"model\": \"gpt-5-2025-08-07\"}\n",
                "        )\n",
                "        \n",
                "        print(f\"A2 FULL batch created: {batch.id}\")\n",
                "        return batch.id\n",
                "        \n",
                "    except Exception as e:\n",
                "        print(f\"Error: {e}\")\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "# Example usage:\n",
                "# a1_test_results = process_completed_batch(\"batch_id_here\", \"A1_test\", \"generated_quiz_A1_test.json\")\n",
                "# a1_full_results = process_completed_batch(\"batch_id_here\", \"A1\", \"generated_quiz_A1.json\")\n",
                "# a2_test_results = process_completed_batch(\"batch_id_here\", \"A2_test\", \"generated_quiz_A2_test.json\")\n",
                "# a2_full_results = process_completed_batch(\"batch_id_here\", \"A2\", \"generated_quiz_A2.json\")\n",
                "\n",
                "print(\"Batch processing notebook ready!\")\n",
                "print(\"\")\n",
                "print(\"WORKFLOW:\")\n",
                "print(\"1. Run TEST batches first (5 items for A1, 3 items for A2)\")\n",
                "print(\"2. Check results and fix any issues\")\n",
                "print(\"3. Run FULL batches (950 items for A1, 150 items for A2)\")\n",
...
print("Robust notebook created with test and full runners!")
