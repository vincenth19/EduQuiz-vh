...
# Create efficient notebook with parameterized functions
notebook = {
    "cells": [
        {
            "cell_type": "code",
        ...
        },
        {
            ...
            "source": [
                ...
                "def run_a1(num_items, batch_suffix=\"\"):\n",
                "    print(f\"Running A1: Single-agent, standard model ({num_items} items)\")\n",
                "    \n",
                "    requests = []\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "def run_a2(num_items, batch_suffix=\"\"):\n",
                "    print(f\"Running A2: Single-agent, reasoning model ({num_items} items)\")\n",
                "    \n",
                "    requests = []\n",
                "    for i in range(min(num_items, len(test_data))):\n",
                "        passage = extract_passage(test_data[i]['prompt'])\n",
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# A3-SS: Standard Generator → Standard Evaluator\n",
                "def run_a3_ss(num_items, batch_suffix=\"\"):\n",
                "    print(f\"Running A3-SS: Standard Generator → Standard Evaluator ({num_items} items)\")\n",
                "    \n",
                "    results = {}\n",
                "    open_items = list(range(min(num_items, len(test_data))))\n",
                "    \n",
                ...
                "                user_prompt = f\"Here are some examples:\\n\\n{k_shot_examples}\\n\\n---\\n\\nGenerate a quiz for this passage:\\n\\n{passage}\"\n",
                "            else:\n",
                "                feedback = results.get(f\"A3-SS{batch_suffix}_{i+1}\", {}).get(\"feedback\", \"Please improve the quiz quality.\")\n",
                "                user_prompt = f\"Here are some examples:\\n\\n{k_shot_examples}\\n\\n---\\n\\nGenerate a quiz for this passage:\\n\\n{passage}\\n\\nPrevious feedback: {feedback}\\nPlease revise accordingly.\"\n",
                "            \n",
                "            gen_requests.append({\n",
                "                \"custom_id\": f\"A3-SS{batch_suffix}_{i+1}_gen_r{round_num}\",\n",
                "                \"method\": \"POST\",\n",
                "                \"url\": \"/v1/chat/completions\",\n",
                "                \"body\": {\n",
                "                    \"model\": \"gpt-4\",\n",
                ...
                "            })\n",
                "        \n",
                "        # Continue with evaluator logic...\n",
                "        print(f\"Would create generator batch with {len(gen_requests)} requests\")\n",
                "        print(\"Note: Full A3 implementation requires multi-round batch processing\")\n",
                "        break  # Simplified for now\n",
                "    \n",
                "    return f\"a3_ss{batch_suffix}_placeholder\""
            ]
        },
        {
            "cell_type": "code",
            ...
            "source": [
                "# A3-SS TEST (2 items)\n",
                "a3_ss_test_batch = run_a3_ss(2, \"_test\")"
            ]
        },
        {
            "cell_type": "code",
            ...
            "outputs": [],
            "source": [
                "# A3-SS FULL (950 items)\n",
                "# a3_ss_full_batch = run_a3_ss(950)"
            ]
        },
        {
            "cell_type": "code",
            ...
            "source": [
                ...
                "\n",
                "print(\"Efficient batch processing notebook ready!\")\n",
                "print(\"\")\n",
                "print(\"USAGE:\")\n",
                "print(\"- run_a1(5, '_test') for 5-item test\")\n",
                "print(\"- run_a1(950) for full 950-item run\")\n",
                "print(\"- run_a2(3, '_test') for 3-item test\")\n",
                "print(\"- run_a2(150) for full 150-item run\")\n",
                "print(\"\")\n",
                "print(\"TEST batches auto-run, FULL batches are commented out for safety.\")"
            ]
        }
    ],
    "metadata": {
...
print("Efficient parameterized notebook created!")
